...
3. For these same genomes, estimate PAR boundaries using TEs.
4. For these same genomes, estimate PAR boundaries using depth (halfdeep).
5. Compute metrics that compare across the three methods for inferring PAR boundaries.
