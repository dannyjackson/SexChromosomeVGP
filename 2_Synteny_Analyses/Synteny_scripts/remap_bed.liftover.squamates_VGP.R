...
bed_file <- sprintf(
  "/data/Wilson_Lab/data/VGP_genomes_phase1/lifted_gffs/squamate_VGP_lifted_gffs/Genespace_input_unfiltered/bed/%s.bed",
  SPECIES
)
...
out_file <- sprintf(
  "/data/Wilson_Lab/data/VGP_genomes_phase1/lifted_gffs/squamate_VGP_lifted_gffs/Genespace_input_unfiltered/bed_reformatted/%s.remapped.bed",
  SPECIES
)
