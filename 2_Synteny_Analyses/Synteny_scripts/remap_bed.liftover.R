...
bed_file <- sprintf(
  "/data/Wilson_Lab/data/VGP_genomes_phase1/lifted_gffs/Genespace_input/bed/%s.bed",
  SPECIES
)
...
out_file <- sprintf(
  "/data/Wilson_Lab/data/VGP_genomes_phase1/lifted_gffs/Genespace_input/bed/%s.remapped.bed",
  SPECIES
)
