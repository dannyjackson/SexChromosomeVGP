...
# cd /data/Wilson_Lab/projects/VGP_Phase_1_Sex_Chr_Project/jacksondan/analyses/Genespace/XZ_Synteny_Gallus_gallus/sex_chroms/sex_shared/
...
# Run from the directory that contains Z/, X/, X1/, ...
...
# Roots to search (edit if you only want e.g. "Z")
# roots <- c("Z","X","X1","X2","X3","X4","X5")
roots <- c("genespace")
