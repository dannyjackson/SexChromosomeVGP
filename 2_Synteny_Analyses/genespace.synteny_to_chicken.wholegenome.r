...
if (length(args) < 2) {
  stop("Usage: Rscript genespace.synteny_to_chicken.r <SPECIES> <OUTDIR>\n",
...
pdf_name <- file.path(OUTDIR, sprintf("%s.Gallus_gallus.5x3.wholegenome.pdf", SPECIES_ID))
...
pdf_name <- file.path(OUTDIR, sprintf("%s.Gallus_gallus.5x3.wholegenome.png", SPECIES_ID))
