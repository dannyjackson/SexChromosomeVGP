...
# add Callospermophilus lateralis
...
# add Callospermophilus lateralis export SQUIRREL_GENES=
...
# add Callospermophilus lateralis export SQUIRREL_PAR_GENES SQUIRREL_PAR_REP SQUIRREL_PAR_PAF
...
awk '{print $11}' $GORILLA_REP | sort -u 

zcat $GORILLA_GENES | head
zcat $SIAMANG_GENES | head
zcat $SHREW_GENES | head
...
Rscript plot_repeats_PAR.ZNF.R GORILLA
Rscript plot_repeats_PAR.ZNF.R SIAMANG
Rscript plot_repeats_PAR.ZNF.R SHREW

Rscript plot_repeats_PAR.smoothed.R GORILLA
Rscript plot_repeats_PAR.smoothed.R SIAMANG
Rscript plot_repeats_PAR.smoothed.R SHREW


# Try plotting different tracks of each repeat class
Rscript plot_repeats_PAR.each_class.R GORILLA
Rscript plot_repeats_PAR.each_class.R SIAMANG
Rscript plot_repeats_PAR.each_class.R SHREW