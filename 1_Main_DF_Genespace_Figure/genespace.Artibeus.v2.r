...
wd <- "/data/Wilson_Lab/projects/VGP_Phase_1_Sex_Chr_Project/jacksondan/analyses/Genespace/Artibeus/version2/figure"
...
ggsave( 
    filename = "Artibeus2.v2.10x3.pdf", 
    plot = p, 
    width = 10, 
    height = 3, 
    units = "in" )
...
ggsave( 
    filename = "Artibeus3.v2.10x3.pdf", 
    plot = p, 
    width = 10, 
    height = 3, 
    units = "in" )
...
ggsave( 
    filename = "Artibeus_spp.v2.10x3.pdf", 
    plot = p, 
    width = 10, 
    height = 3, 
    units = "in" )
...
invchr <- data.frame(
  genome = c("Artibeus_lituratus", "Artibeus_lituratus", "Artibeus_intermedius"), 
  chr = c("X", "Y2", "Y2"))
...
ggsave( 
    filename = "Artibeus_spp.v2.sex_chrs.10x3.pdf", 
    plot = p, 
    width = 5, 
    height = 3, 
    units = "in" )