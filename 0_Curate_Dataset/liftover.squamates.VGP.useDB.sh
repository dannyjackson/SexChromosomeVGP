...
GFF_QRY="/data/Wilson_Lab/data/VGP_genomes_phase1/lifted_gffs/squamate_VGP_lifted_gffs/${SPECIES}/lifted.${ACCESSION}.0_5.gff"
FNA_QRY_GLOB="/data/Wilson_Lab/data/VGP_genomes_phase1/genomes/${SPECIES}/ncbi_dataset/data/${ACCESSION}/${ACCESSION}"*genomic.fna
